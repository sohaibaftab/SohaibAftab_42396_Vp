...
namespace Vp_semester_Project
{
    public partial class Registration : Form
    {
        ...
        private void SingUp_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string str = "insert into AddUser(userName,password,firstName,secondName,contact,email,fscMarks,matricMarks,address) VALUES('" + textBox1.Text + "','" + textBox9.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + textBox6.Text + "','" + textBox7.Text + "','" + textBox8.Text + "')";
